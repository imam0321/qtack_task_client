...
export default function ImageUploadInput({
    ...
    return (
        <div className="space-y-1">
            <label className="block text-sm font-semibold text-slate-700">Company Icon</label>
            <div
            ...
            >
                {previewSrc ? (
                    <div className="relative w-full h-full p-2">
                        <Image src={previewSrc} fill alt="Preview" className="object-contain rounded-xl p-1" />
