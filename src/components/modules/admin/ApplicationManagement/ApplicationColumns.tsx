...
export const ApplicationColumns: Column<IApplication>[] = [
  {
    ...
    accessor: (app) => (
      <div className="min-w-40">
        <h3 className="font-semibold text-slate-900 text-sm md:text-base text-nowrap">
          {app.name}
        </h3>
    ...
    accessor: (app) => {
      ...
      return (
        <div className="flex items-center gap-2 min-w-35">
          <span className="font-medium text-slate-700 text-sm truncate max-w-30 md:max-w-none">
            {job?.title}
          </span>
